...
export default function EditProfileForm({ form, handleChange, handleSubmit }: EditProfileProps) {
  return (
    <form action="">
      ...
      <div className="button-group d-flex flex-column pt-40">
        <Button className="btn btn-save fw-medium text-lg text-white rounded-pill" action={handleSubmit}>
          Update My Profile
        </Button>
      </div>
    </form>
