              ...
              <Link href="/detail">
                <a>
                  <div className="blur-sharp">
                    <img src={`https://bwa-topup-store.herokuapp.com/uploads/cover-games/${item.coverGames}`} width="205" height="270" alt="cover-games" />
                  </div>
                  <div className="cover position-absolute bottom-0 m-32">
                    <div className="d-flex flex-column h-100 justify-content-between text-decoration-none">
                      ...
                      <div>
                        <p className="fw-semibold text-white text-xl m-0">{item.gameName}</p>
                        <p className="fw-light text-white m-0">{item.category.name}</p>
                      </div>
                    </div>
                  </div>
                </a>
