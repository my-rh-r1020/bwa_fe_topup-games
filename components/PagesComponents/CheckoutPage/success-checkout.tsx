    ...
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
      <div className="container-fluid">
        ...
        <div className="button-group d-flex flex-column mx-auto">
          <Button className="btn btn-dashboard fw-medium text-lg text-white rounded-pill mb-16" action={() => handleRouter()}>
            My Dashboard
          </Button>
          <Button className="btn btn-whatsapp fw-medium text-lg color-palette-1 rounded-pill" action="#">
            WhatsApp ke Admin
          </Button>
        </div>
      </div>
